...
if args_len < 3:
    sys.exit("Too few arguments provided.\nUsage: python3 length_rsp_terminates_connection.py 'serial_port' 'advertiser_address', ['pcap_filename']")
...
if args_len == 4:
    ...
    pcap_filename = 'length_rsp_terminates_connection_log'
...
for _ in range(10):
    ...
    if output != ble_sul.EMPTY:
        response_received = True

if not response_received:
    print(Fore.YELLOW + "Device may have terminated the connection.")
